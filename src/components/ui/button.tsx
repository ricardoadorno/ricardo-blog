  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all cursor-pointer disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        gradientNeon:
          "btn-gradient-neon shadow-md",
        glass:
          "glass text-foreground shadow-md hover:shadow-lg backdrop-blur-xl",
        destructive:
          "bg-destructive text-white shadow-md hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 hover:-translate-y-0.5",
        outline:
          "border border-border/50 bg-background/50 shadow-sm hover:bg-accent hover:text-accent-foreground dark:bg-input/20 dark:border-border dark:hover:bg-input/40 backdrop-blur-sm hover:border-primary/50",
        secondary:
